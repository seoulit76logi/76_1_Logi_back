...
public class DeliveryController {
    ...
    public void getReturnAbleList(@RequestAttribute("reqData") PlatformData reqData,
        ...
        datasetBeanMapper.beansToDataset(resData, returnList, ReverseTO.class);
    }
    ...
    public void getSalesQuaChart(@RequestAttribute("reqData") PlatformData reqData,
        ...
        datasetBeanMapper.beansToDataset(resData, salesQuaList, QuarterTO.class);
    }

    @RequestMapping(value = "/ReturnRegister")
    public void registerReturn(@RequestAttribute("reqData") PlatformData reqData,
                               @RequestAttribute("resData") PlatformData resData) throws Exception {
        List<ReverseTO> reverseTOList = datasetBeanMapper.datasetToBeans(reqData, ReverseTO.class);
        salesService.insertReturnList(reverseTOList);
    }
}
