...
public class SalesServiceImpl implements SalesService {
    ...
    public void insertReturnList(List<ReverseTO> reverseList) {
        for (ReverseTO to : reverseList) {
            if ("1".equals(to.getChecked())) {
                HashMap<String, String> map = new HashMap<>();
                map.put("deliveryNO", to.getDeliveryNO());
                map.put("itemCode", to.getItemCode());
                map.put("returnUnit", to.getReturnUnit());
